...
class MaskingConsistencyModule(Module):
    ...
    def __call__(self,
        ...
        #print(type(masked_lbl))
        #print(type(masked_seg_weight))
        #print(masked_img.cpu().numpy().shape)
        #print(masked_lbl.cpu().numpy().shape)
        #print(masked_seg_weight.cpu().numpy().shape)
        #plt.imshow(masked_img.cpu().numpy()[0,0,:,:])
        #plt.show()
        #plt.imshow(masked_lbl.cpu().numpy()[0,0,:,:])
        #plt.show()
        #plt.imshow(masked_seg_weight.cpu().numpy()[0,:,:])
        #plt.show()
